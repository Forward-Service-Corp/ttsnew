            ...
            <div className={"flex justify-between py-8"}>
                <div>
                    <button disabled={currentTab === 1} onClick={prevPage}
                            className={"text-xs bg-indigo-700 hover:bg-indigo-500 mx-8 m-auto text-white py-2 px-8 text-center rounded-full disabled:bg-gray-300"}>Previous
                        page
                    </button>
                </div>
                <div>
                    <button onClick={nextPage}
                            className={"text-xs bg-indigo-700 hover:bg-indigo-500 mx-8 m-auto text-white py-2 px-8 text-center rounded-full disabled:bg-gray-300"}>
