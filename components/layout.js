...
export default function Layout({children, title, session, loadingState, version, simpleModalTitle, simpleModalMessage, simpleModalLabel, simpleModal}) {
    ...
    return (
        <>
            <div className={`${environment === "dev" || environment === "testing" || environment === "training" ? "visible" : "hidden"} ${environment === "testing" ? "bg-pink-600" : "bg-indigo-600"} p-4 text-center text-xs text-white font-light`}>
