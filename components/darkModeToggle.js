...
export default function DarkModeToggle({ setDarkMode, session }) {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute h-full w-full rounded-md bg-white dark:bg-gray-800"
      />
      <span
        aria-hidden="true"
