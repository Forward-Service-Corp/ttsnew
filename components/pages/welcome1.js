    ...
    return (
        <div className={"font-light"}>
            ...
            <p className={"text-sm"}>
                ...
                and work together to make those dreams come true. Just like taking a trip, know where you are going to
                make sure you get there. Go after what you want. Make your dreams become reality. Mapping Dreams is for
            ...
            <p className={"text-sm"}>
                ...
                to ask for help, determination, and money. Making a real plan, designed by you, that will work for you, is the
                path to your success.
            </p>

            <p className={"text-sm"}>
                Each step you take brings you one step closer to your dream. Each step is a reason to celebrate.
                And, when &quot;life happens&quot; and a step suddenly turns into a slip or a fall, YOU start again. Just
