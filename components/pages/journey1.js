    ...
    return (
        <div className={"text-sm p-4 bg-gray-100"}>
            ...
            <p>If you’re going to the store and the usual road is closed, what to you do? Turn around and go home?
                ...
                your journey.</p>
            <p className={"text-center text-lg"}>If at first you don’t succeed try and try again. (E. Hickson)</p>
            <p className={"text-center text-lg font-bold"}>Map of My Dreams – Tips to Success</p>
            ...
            <p className={"text-center mt-4"}><strong>“A Problem will get heavier when the only person carrying it is you.”</strong> OMGQuotes.com </p>
            <p className={"text-center mt-4"}><strong>“The best advice... never be afraid to ask for help.”</strong> Demi Lovato</p>
            <p className={"text-center mt-4"}><strong>“There is no shame in asking for help, it is one of the most courageous things you will ever
                do...”</strong> Laura Lane</p>
            <p className={"text-center mt-4"}><strong>“The only mistake you can make is not asking for help.”</strong> Sandeep Jauhar”</p>
            <h2 className={"mt-8 font-bold text-lg text-center"}>More tips for success...</h2>
            <ul className={"list-disc ml-4"}>
                <li>Place a copy of the “IF” poem and other inspiring messages in the places you will see them. Use them,
                    especially in tough times.</li>
                <li>Use the stories of others overcoming challenges as your inspiration, especially during difficult times.</li>
